...
<head>
    ...
    <link href="{{url('/template/vendors/datatables.net-bs4/css/dataTables.bootstrap4.css')}}" rel="stylesheet">
...
<body>
    ...
    <div class="sidebar sidebar-dark sidebar-fixed" id="sidebar">
        <div class="sidebar-brand d-none d-md-flex">
            <img src="{{url('/template/assets/favicon/pura-icon.png')}}" alt="..." style="width: 35px;height: 35px">
            <h5 style="margin-bottom: 0rem; margin-left: 0.5rem">Pendataan Pura</h5>
        </div>
